...
public class SearchInrotatedSortedArray{
    public static int bruteForceMethod(int target,int[]arr){
        //brouteforce tc: O(n)
    ...
    public static int BinarySearchMethod(int target,int[]arr){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BinarySearchMethod(target, arr));
